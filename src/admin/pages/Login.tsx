    ...
    <main className="grid min-h-dvh bg-canvas lg:grid-cols-2">
      <div className="relative hidden overflow-hidden bg-[#111714] lg:block">
        ...
        <div className="relative flex h-full flex-col justify-end p-14 text-white">
          <p className="display text-5xl leading-tight">Digital Guest Hub</p>
          <p className="mt-4 max-w-md text-white/70">Operations console and website manager for your hotel’s digital concierge — requests, menus, services and branding in one place.</p>
        </div>
      </div>
      <div className="flex items-center justify-center px-6 py-12">
        ...
        >
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500">Use the account provided by your hotel administrator.</p>
          </div>
          ...
          <Field label="Email" htmlFor="login-email" error={fields.email}>
          ...
          <Field label="Password" htmlFor="login-password" error={fields.password}>
          ...
          <Button type="submit" block size="lg" className="rounded-xl" loading={m.isPending}>
            Sign in
          </Button>
        </form>
      </div>
